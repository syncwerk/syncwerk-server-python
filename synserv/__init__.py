...
import service
from service import ccnet_rpc, syncwserv_rpc, syncwserv_threaded_rpc, ccnet_threaded_rpc
...
from service import CCNET_CONF_PATH, CCNET_SERVER_ADDR, CCNET_SERVER_PORT, \
    ...
    SYNCWERK_CENTRAL_CONF_DIR, LDAP_HOST

from service import send_message

from api import syncwerk_api, ccnet_api
